# Generated by Django 4.1.6 on 2023-03-02 23:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user_from', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_set', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddIndex(
            model_name='post',
            index=models.Index(fields=['slug'], name='apps_post_slug_e3c710_idx'),
        ),
        migrations.AddIndex(
            model_name='comment',
